...
TEAM_BANDITSCOUT = AddExtraTeam("Bandit Scout", {
	color = Color(75, 75, 75, 255),
	model = {
		"models/player/Group03/Female_01.mdl",
		"models/player/Group03/Female_02.mdl",
		...
		"models/player/Group03/Male_08.mdl",
		"models/player/Group03/Male_09.mdl"},
	description = [[You are a Bandit Scout! You use your Climbing Skills to scout places that your fellow bandits cant get to
	you work for the mobboss and follow his orders!]],
	weapons = {"climb_swep2","fas2_dv2"},
	command = "banditscout",
	max = 3,
	salary = 80,
	admin = 0,
